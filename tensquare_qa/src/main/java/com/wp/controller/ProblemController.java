...
import com.wp.service.ProblemService;
...
public class ProblemController {
	...
	public Result findAll(){
		return new Result(true,StatusCode.OK.getStatus(),"查询成功",problemService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(true,StatusCode.OK.getStatus(),"查询成功",problemService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new Result(true,StatusCode.OK.getStatus(),"查询成功",  new PageResult<Problem>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(true,StatusCode.OK.getStatus(),"查询成功",problemService.findSearch(searchMap));
    }
	...
	public Result newList(@PathVariable String label,@PathVariable Integer page,@PathVariable Integer size ){
		...
		return new Result(true,StatusCode.OK.getStatus(),"查询成功",new PageResult<Problem>( problems.getTotalElements(),problems.getContent() ));
	}
