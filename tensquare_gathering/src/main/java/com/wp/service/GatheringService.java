...
import com.wp.dao.GatheringDao;
 ...
 */
@Service
@CacheConfig(keyGenerator = "customerkeyGenerator",
		cacheManager = "redisCacheManager",cacheNames = "tensquare_gathering")
...
public class GatheringService {
	 ...
	 */
	@Cacheable(key = "#id")
	public List<Gathering> findAll(String id) {
	 ...
	 * @return
	 */
	@Cacheable(key = "tensquare_gathering_+#id")
	 ...
	 * @param gathering
	 */
	@CachePut(key = "tensquare_gathering_+#gathering.id")
	 ...
	 * @param gathering
	 */
	@CacheEvict(key = "tensquare_gathering_+#gathering.id")
	 ...
	 * @param id
	 */
	@CacheEvict(key = "tensquare_gathering_+#id")
